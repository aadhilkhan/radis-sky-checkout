      ...
      <div className="bg-muted/50 w-full rounded-xl p-4">
        <div className="flex flex-col gap-2 text-sm">
          <div className="flex justify-between">
            ...
            <span className="font-medium">{formatAmount(config.orderAmount)}</span>
          </div>
          {plan && (
            <>
              <div className="flex justify-between">
              ...
              {plan.installments > 1 && (
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{formatAmount(installmentAmount)}</span>
                </div>
              )}
            </>
          )}
          ...
          <div className="flex justify-between">
            ...
            <span className="font-semibold">{formatAmount(installmentAmount)}</span>
          </div>
        </div>
      </div>
